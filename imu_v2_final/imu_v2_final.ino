...
void bmx_process()
{
  ...
  Serial.print("M ");
  Serial.print("X: "); Serial.print(int(Omagn.x)); Serial.print("  ");
  Serial.print("Y: "); Serial.print(int(Omagn.y)); Serial.print("  ");
  ...
  Serial.print("Z: "); Serial.print(6 - int(Ogyro.z)); Serial.print("  ");
  Serial.println("g");
  
  /* Display the accelerometer results (accelerometer data is in m/s^2) */
  Serial.print("A ");
  Serial.print("X: "); Serial.print(Oaccel.x    ); Serial.print("  ");
  Serial.print("Y: "); Serial.print(7.5 - int(Oaccel.y)    ); Serial.print("  ");
